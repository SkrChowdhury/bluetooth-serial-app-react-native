                ...
                <View style={{width: 48, height: 48, opacity: 0.4}}>
                  {connectedId === device.id ? (
                    <Image
                      ...
                      source={require('./assets/ic_done_black_24dp.png')}
                    />
                  ) : null}
                </View>
              ) : null}
        ...
        .then(data => {
          if (data) {
            ...
            this.setState(prevState => ({
              readingData: data,
              previousReadingData: prevState.readingData,
              modalVisible: data !== '' || data === prevState.readingData,
            }));
          }
          // Process the received data

          // Continue reading data after a delay (e.g., 1000 milliseconds)
          setTimeout(() => {
            this.readData();
          }, 10);
        })
        ...
        {this.state.modalVisible && (
          <Modal
            ...
            visible={
              ...
              this.state.readingData === this.state.previousReadingData
            }
            nRequestClose={() => {
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <View style={{flexDirection: 'row'}}>
                  ...
                  <Text>{this.state.readingData}</Text>
                </View>
                ...
                <TextInput
                  ...
                  onChangeText={text => this.setState({writingData: text})}
                  value={this.state.writingData}
                  placeholder="Type your message"
                />

                <TouchableOpacity
                  style={[styles.button, styles.buttonOpen, {marginTop: 10}]}
                  onPress={() => this.write(this.state.writingData)}>
